# Benchmark Report — Codebase Insights v1.0.1
...
- **Peak RSS:** **2844.5 MiB**
- **No-change catch-up:** 30.24s  (indexed=0, skipped=118)
...
Leaf file: `G:\SyntaxSenpai\apps\mobile\app\(onboarding)\_layout.tsx`  
...
|---|---|---|---|---|---|
| A: No-change restart | 0.33s | 0.15s | — | 15.31s | 30.24s |
| B: Leaf file edit (_layout.tsx) | — | 20.30s | — | — | 27.22s |
| C: Core file edit (useTheme.ts) | — | 3.65s | 6.99s | 14.44s | 63.17s |
| D: New file added | — | 3.90s | 3.93s | 16.43s | 67.01s |

### Per-scenario BENCHMARK lines

#### Scenario A: No-change restart
- `[BENCHMARK:STARTUP]` `lsp_javascript/typescript_start_server=0.027s`  `lsp_javascript/typescript_initialize=0.543s`  `lsp_cpp_start_server=0.022s`  `lsp_cpp_initialize=0.268s`
- `[BENCHMARK:INDEXER]` `wall_time=0.33s`  `files_total=118`  `indexed=0`  `skipped=118`  `errors=0`  `total_symbols=5592`  `total_refs=31791`
- `[BENCHMARK:SEMANTIC]` `wall_time=0.15s`  `pending_query=0.112s`  `context_extract=0.03s`  `llm_batch=0.00s`  `chroma_insert=0.00s`  `sqlite_write=0.00s`  `symbols_total=531`  `summarised=0`  `skipped=531`  `errors=0`  `input_tokens=0`  `output_tokens=0`
- `[BENCHMARK:PROJECT_SUMMARY]` `wall_time=15.31s`  `mode=full`
- `[BENCHMARK:SIZES]` `sqlite_bytes=6676480`  `chroma_bytes=9143256`  `sqlite_mb=6.37`  `chroma_mb=8.72`

#### Scenario B: Leaf file edit (_layout.tsx)
File: `G:\SyntaxSenpai\apps\mobile\app\(onboarding)\_layout.tsx`  
- `[BENCHMARK:SEMANTIC]` `wall_time=20.30s`  `pending_query=0.031s`  `context_extract=0.00s`  `llm_batch=4.32s`  `chroma_insert=15.93s`  `sqlite_write=0.02s`  `symbols_total=2`  `summarised=1`  `skipped=1`  `errors=0`  `input_tokens=121`  `output_tokens=36`

#### Scenario C: Core file edit (useTheme.ts)
File: `G:\SyntaxSenpai\apps\mobile\src\hooks\useTheme.ts`  
- `[BENCHMARK:SEMANTIC]` `wall_time=3.65s`  `pending_query=0.023s`  `context_extract=0.05s`  `llm_batch=3.07s`  `chroma_insert=0.48s`  `sqlite_write=0.01s`  `symbols_total=7`  `summarised=1`  `skipped=6`  `errors=0`  `input_tokens=119`  `output_tokens=40`
- `[BENCHMARK:FILE_SUMMARIES]` `wall_time=6.99s`  `files_pending=1`
- `[BENCHMARK:PROJECT_SUMMARY]` `wall_time=14.44s`  `mode=incremental`  `changes=2`
- `[BENCHMARK:SIZES]` `sqlite_bytes=6676480`  `chroma_bytes=9143256`  `sqlite_mb=6.37`  `chroma_mb=8.72`

#### Scenario D: New file added
File: `_bench_auto_scenario_d.ts`  
- `[BENCHMARK:SEMANTIC]` `wall_time=3.90s`  `pending_query=0.019s`  `context_extract=0.00s`  `llm_batch=3.04s`  `chroma_insert=0.82s`  `sqlite_write=0.01s`  `symbols_total=4`  `summarised=4`  `skipped=0`  `errors=0`  `input_tokens=512`  `output_tokens=168`
- `[BENCHMARK:FILE_SUMMARIES]` `wall_time=3.93s`  `files_pending=1`
- `[BENCHMARK:PROJECT_SUMMARY]` `wall_time=16.43s`  `mode=incremental`  `changes=2`
- `[BENCHMARK:SIZES]` `sqlite_bytes=6676480`  `chroma_bytes=9147352`  `sqlite_mb=6.37`  `chroma_mb=8.72`
